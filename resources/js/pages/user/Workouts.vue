                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <v-btn
                                                                            ...
                                                                            dark
                                                                            rounded
                                                                            @click="$router.push({ name: 'my-workout', params: { id: item.id } })"
                                                                        >
                                                                            <v-icon small>
                                                                                mdi-eye
                                                                            </v-icon>
                                                                        ...
                                                                        <v-btn
                                                                            ...
                                                                            dark
                                                                            rounded
                                                                            @click="$router.push({ name: 'my-workout', params: { id: item.id, edit: true }})"
                                                                        >
                                                                            <v-icon small>
                                                                                mdi-pencil
                                                                            </v-icon>
...
export default {
    ...
    methods: {
        setWorkouts: async function () {
            try {
                const { data } = await axios.get('/account/workouts');
                this.workouts = data;
            }
            catch(error) {
